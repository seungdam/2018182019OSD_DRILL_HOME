...
PIXEL_PER_METER = (143.0 / 0.9) # 10 pixel  30dm
...
class IdleState:
    ...
    def draw(boy):
        if boy.dir == 1:
            boy.image.clip_draw(int(boy.frame) * 184, 300, 184, 169, boy.x, boy.y)
        else:
            boy.image.clip_draw(int(boy.frame) * 184, 200, 184, 169, boy.x, boy.y)
